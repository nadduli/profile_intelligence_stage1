...
COUNTRY_MAP = {
    ...
    "malawi": "MW", "rwanda": "RW", "benin": "BJ", "togo": "TG",
    "mali": "ML", "niger": "NE", "chad": "TD", "sudan": "SD",
    "egypt": "EG", "morocco": "MA", "algeria": "DZ", "tunisia": "TN",
    "libya": "LY", "somalia": "SO", "eritrea": "ER", "djibouti": "DJ",
    "south africa": "ZA", "namibia": "NA", "botswana": "BW",
    "ivory coast": "CI", "burkina faso": "BF", "guinea": "GN",
    "sierra leone": "SL", "liberia": "LR", "gambia": "GM",
    "dr congo": "CD", "congo": "CG", "central african republic": "CF",
    "gabon": "GA", "cape verde": "CV", "comoros": "KM",
    "lesotho": "LS", "madagascar": "MG", "mauritania": "MR",
    "mauritius": "MU", "seychelles": "SC", "south sudan": "SS",
    "eswatini": "SZ", "western sahara": "EH", "equatorial guinea": "GQ",
    "guinea-bissau": "GW", "australia": "AU", "brazil": "BR",
    "canada": "CA", "china": "CN", "france": "FR", "germany": "DE",
    "india": "IN", "japan": "JP", "united kingdom": "GB",
    "united states": "US",
